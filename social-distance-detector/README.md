...
- cocoで学習したyolo v3の重みファイルが100MB以上でuploadできなかった。なので、上のリンクから重みファイル含めたファイル一式をダウンロードしないとだめ！！！！
...
$ python social_distance_detector.py -i input/dog.jpg -l dog   # 予測クラスを「dog」にする。cocoのクラス名で変更できる
